...
import com.example.wheathercomposemvi.domain.usecase.GetCurrentWeatherUseCase
import com.example.wheathercomposemvi.domain.usecase.GetFavouriteCitiesUseCase
import com.example.wheathercomposemvi.presentation.favourite.FavouriteStore.Intent
import com.example.wheathercomposemvi.presentation.favourite.FavouriteStore.Label
import com.example.wheathercomposemvi.presentation.favourite.FavouriteStore.State
...
class FavouriteStoreFactory @Inject constructor(
    ...
    private val getGetFavouriteCitiesUseCase: GetFavouriteCitiesUseCase,
    private val getGetCurrentWeatherUseCase: GetCurrentWeatherUseCase,
) {
    ...
    private inner class BootstrapperImpl : CoroutineBootstrapper<Action>() {
        override fun invoke() {
            scope.launch {
                getGetFavouriteCitiesUseCase().collect {
    ...
    private inner class ExecutorImpl : CoroutineExecutor<Intent, Action, State, Msg, Label>() {
        ...
        private suspend fun loadWeatherForCity(city: City) {
            ...
            try {
                val weather = getGetCurrentWeatherUseCase(city.id)
                dispatch(
                    Msg.WeatherLoaded(
                        cityId = city.id,
                        tempC = weather.tempC,
